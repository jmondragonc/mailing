  ...
  data.map((item, i) => {
    ...
    if (item.nuevo == "SI") {
      ...
      if (item.foto != null && item.foto != "") {
        foto = `https://juntosmovemoselmundo.pe/mailing/volvo/2026/01/fotos/${item.foto}`;
      } else {
        foto = "https://juntosmovemoselmundo.pe/mailing/2025/portada_nuevo.jpg";
      }
      console.log("1", item.mail);
      let mailOptions = {
        from: "no-reply@juntosmovemoselmundo.pe",
        to: `${item.mail}`,
        //replyTo: `${item.mail_asesor}`,
        replyTo: `no-reply@juntosmovemoselmundo.pe`,
        subject:
                        ...
                        <tr>
                          <td>
                            <span style="font-size: 0; line-height: 0"
                              ><img
                                src="https://juntosmovemoselmundo.pe/mailing/volvo/2026/01/${item.header}"
                                width="750"
                                height="296"
                                alt=""
                                style="display: block"
            ...
            <tr>
              ...
              <td width="87"><img src="https://juntosmovemoselmundo.pe/mailing/volvo/2025/right.png" width="87" height="439" alt="" style="display: block;"/></td>
                        ...
                        <tr>
                          <td>
                            <img
                              src="https://juntosmovemoselmundo.pe/mailing/volvo/2026/01/${item.footer}"
                              width="750"
                              height="716"
                              alt=""
                              style="display: block"
